...
import comapnyImage from "../../assets/Image2.jpg";

const About = () => {
  return (
    <div className="container mx-auto px-4 py-32 max-w-7xl">
      <div className="relative rounded-2xl overflow-hidden shadow-2xl mb-24">
        <img src={comapnyImage} className="w-full h-full object-cover" />
      ...
      <div className="mb-24 max-w-4xl mx-auto">
        ...
        <div className="text-lg leading-relaxed text-gray-600 space-y-6">
          <p>
            JM Company는 1995년 설립 이래로 전력 변환 장치 및 전력 제어 시스템
          ...
          {[
            ...
            <div
              ...
              className={`flex items-center gap-8 ${
                index % 2 === 0 ? "felx-row" : "flex-row-reverse"
              }`}
            >
              <div className="w-1/2 text-center">
                <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-2xl transition-all duration-300 border border-x-gray-100">
